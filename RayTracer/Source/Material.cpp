...
bool Lambertian::Scatter(const Ray& incident, const rayCastHit& raycastHit, color3_t& attenuation, Ray& scattered) const {
...
bool Metal::Scatter(const Ray& incident, const rayCastHit& raycastHit, color3_t& attenuation, Ray& scattered) const {
...
bool Dielectric::Scatter(const Ray& incident, const rayCastHit& raycastHit, color3_t& attenuation, Ray& scattered) const {
    glm::vec3 outNormal;
    float ni_over_nt;
    float cosine;
    ...
    // acts as a tint to the transparent material (glass)
    attenuation = albedo;

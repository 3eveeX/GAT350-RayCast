...
public:
	...
	bool Scatter(const Ray& incident, const rayCastHit& raycastHit, color3_t& attenuation, Ray& scattered) const override;
};
...
public:
	...
	bool Scatter(const Ray& incident, const rayCastHit& raycastHit, color3_t& attenuation, Ray& scattered) const override { return false; }
